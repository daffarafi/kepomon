"""
Django settings for kepomon project.
...
CSRF_TRUSTED_ORIGINS = ['https://kepomon.up.railway.app']

ROOT_URLCONF = 'kepomon.urls'
...
WSGI_APPLICATION = 'kepomon.wsgi.application'
